...
class TestTopic(Node):
    ...
    def __init__(self):
        ...
        self.sub_data = self.create_subscription(WebInput, '/input_data_web', self.callback_inputData, 10)
        self.timer_period = 1.0
        self.pub_data = self.create_publisher(WebOutput, '/output_data_web', 10)
