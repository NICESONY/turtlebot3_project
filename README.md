...
|날짜|조원|시간|작업 내용|
|:---:|:---:|:---:|:---|
|2025/07/21 |모두 참여|하루 종일|1. 주제 정하기 <br> 2. github 세팅<br> 3. 계획서 작성<br> 4. PPT 작성 중<br> 5. gazebo map 초기 세팅|
|2025/07/22 |오른쪽정렬|중앙정렬|중앙정렬|
|2025/07/23 |오른쪽정렬|중앙정렬|중앙정렬|
|2025/07/24 |오른쪽정렬|중앙정렬|중앙정렬|
|2025/07/25 |오른쪽정렬|중앙정렬|발표, PPT 완성 예정|
