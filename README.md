...
|2025/07/24 |손건희|오후||
| | <br>| | |
|2025/07/25 |모두 참여|중앙정렬|발표, PPT 완성 예정, 시연영상 보내기, 터틀봇 정리, 서브모터, 선, 아두이노, 글로건 제출, |
...
|2025/07/22 |곽정미|ROS 노드와 시리얼 통신 연동: 사용자 입력 받아 dump 구동 실행|
|2025/07/23 |곽정미|ROS 2 기반 서비스 노드 구현: 무선으로 신호 입출력 가능|
