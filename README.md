...
- 1. 특정 베터리 이하일 경우 충전 구역으로 이동 --> slam
- 2. 웹에서 클릭시 특정 구역으로 이동 + slam 
- 3. 웹에서 클릭 시 자율 수확 모드(사람을 따라다니면서 수확 진행) + slam  + vision
  #### 번외
...
|2025/07/22 |모두 참여|오전|1. 웹과 ROS 연동 중<br> 2. 추가적인 모터 설치 중<br> 3. 아르코 마커 진행 중<br>4. 베터리 전압 토픽 확인 중 + 연결|
|2025/07/22 |모두 참여|오후|중앙정렬|
|2025/07/23 |모두 참여|오전|중앙정렬|
|2025/07/23 |모두 참여|오후|중앙정렬|
|2025/07/24 |모두 참여|오전|중앙정렬|
|2025/07/24 |모두 참여|오후|중앙정렬|
