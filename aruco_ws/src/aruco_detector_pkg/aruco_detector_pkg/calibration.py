...
if __name__ == "__main__":
    # 체커보드 이미지가 저장된 폴더
    img_path = 'src/aruco_detector_pkg/aruco_detector_pkg/calib_img'
    ...
    if ret:
        ...
        np.savez("src/aruco_detector_pkg/aruco_detector_pkg/camera_calibration.npz", camera_matrix=camera_matrix,
